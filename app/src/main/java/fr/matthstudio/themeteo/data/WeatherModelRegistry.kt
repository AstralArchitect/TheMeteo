...
object WeatherModelRegistry {
    val models = listOf(
        ...
        WeatherModel("ecmwf_ifs", settingNameResId = R.string.meilleur_mod_le_par_d_faut, sourceName = "ECMWF IFS", isGlobal = true, predictionDays = 14, secondaryModelApiName = "gfs_seamless"),
        WeatherModel("gfs_seamless", settingNameRaw = "NCEP GFS Seamless", sourceName = "GFS", isGlobal = true, predictionDays = 15, secondaryModelApiName = null),
        WeatherModel("meteofrance_seamless", settingNameRaw = "Météo France Seamless", sourceName = "Météo France", isGlobal = true, predictionDays = 3, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("knmi_harmonie_arome_europe", settingNameRaw = "KNMI Harmonie Arome Europe", sourceName = "Harmonie Arome", isGlobal = false, minLat = 45.0, maxLat = 60.0, minLon = -10.0, maxLon = 20.0, predictionDays = 2, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("dmi_harmonie_arome_europe", settingNameRaw = "DMI Harmonie Arome Europe", sourceName = "Harmonie Arome", isGlobal = false, minLat = 40.0, maxLat = 75.0, minLon = -20.0, maxLon = 50.0, predictionDays = 2, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("ukmo_seamless", settingNameRaw = "UK Met Office Seamless", sourceName = "UK Met Office", isGlobal = true, predictionDays = 5, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("meteoswiss_icon_seamless", settingNameRaw = "MeteoSwiss ICON Seamless", sourceName = "MeteoSwiss", isGlobal = false, minLat = 45.0, maxLat = 48.0, minLon = 5.0, maxLon = 11.0, predictionDays = 3, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("icon_seamless", settingNameRaw = "ICON Seamless", sourceName = "Deutscher Wetterdienst", isGlobal = true, predictionDays = 7, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("kma_gdps", settingNameRaw = "KMA GDPS", sourceName = "KMA", isGlobal = true, predictionDays = 10, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("kma_ldps", settingNameRaw = "KMA LDPS", sourceName = "KMA", isGlobal = false, minLat = 32.0, maxLat = 40.0, minLon = 124.0, maxLon = 132.0, predictionDays = 3, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("bom_access_global", settingNameRaw = "BOM ACCESS Global", sourceName = "BOM", isGlobal = true, predictionDays = 10, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("cma_grapes_global", settingNameRaw = "CMA GRAPES Global", sourceName = "CMA", isGlobal = true, predictionDays = 10, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("ecmwf_ifs025", settingNameRaw = "ECMWF IFS 0.25°", sourceName = "ECMWF IFS", isGlobal = true, predictionDays = 14, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("ncep_aigfs025", settingNameRaw = "NCEP AIGFS 0.25°", sourceName = "AIGFS", isGlobal = true, predictionDays = 14, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("ncep_hgefs025_ensemble_mean", settingNameRaw = "NCEP HGEFS 0.25° Ensemble Mean", sourceName = "NCEP", isGlobal = true, predictionDays = 16, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("gfs_graphcast025", settingNameRaw = "NCEP GFS GraphCast", sourceName = "GFS", isGlobal = true, predictionDays = 15, secondaryModelApiName = "ecmwf_ifs"),
        WeatherModel("gem_seamless", settingNameRaw = "GEM Seamless", sourceName = "GEM", isGlobal = true, predictionDays = 9, secondaryModelApiName = "ecmwf_ifs"),
        ...
        WeatherModel("jma_seamless", settingNameRaw = "JMA Seamless", sourceName = "JMA", isGlobal = true, predictionDays = 10, secondaryModelApiName = "ecmwf_ifs"),
