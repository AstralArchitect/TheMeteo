...
fun DayChooser(weatherViewModel: WeatherViewModel) {
    ...
    Column(
        ...
        Text(
            text = stringResource(R.string.next_days_temperature_forecast, (dailyForecast as? WeatherDataState.SuccessDaily)?.data?.size ?: 0),
        ...
        if (dailyForecast == WeatherDataState.Loading) {
            ...
            LazyColumn(
                ...
                items((dailyForecast as WeatherDataState.SuccessDaily).data) { dayReading ->
